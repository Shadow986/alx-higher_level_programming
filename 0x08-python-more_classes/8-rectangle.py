...
class Rectangle:
    ...
    # Public class attribute to store the symbol for string representation
    print_symbol = "#"
    ...
    def width(self, value):
        """This setter method sets the width of the rectangle
    ...
    def height(self, value):
        """This setter method sets the height of the rectangle
        to a positive integer value."""
        if type(value) is not int:
    ...
    def __str__(self):
        ...
        rectangle with the character(s) stored in print_symbol."""
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def __del__(self):
        """This method prints a message when
    ...
    def bigger_or_equal(rect_1, rect_2):
        """This static method returns the biggest
